...
interface BrainItemRenderer {
    ...
    private fun renderCentralGlyph(graphics: TileGraphics){
        graphics.draw(
    ...
    private fun renderCorners(graphics: TileGraphics){
    ...
    fun Circuitry.renderCircuitry(graphics: TileGraphics){
